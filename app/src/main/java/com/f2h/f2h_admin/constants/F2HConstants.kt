...
object F2HConstants {
    ...
    const val DELIVERY_STATUS_NOT_DONE = "OPEN"
    const val DELIVERY_STATUS_COMPLETED = "DELIVERED"
    const val ALL_DELIVERY_AREA = "ALL"
    const val TIME_SELECTION_TODAY = "Today"
